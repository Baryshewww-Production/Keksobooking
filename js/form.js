...
const onClickResetButton = (evt) => resetForm(evt);
...
avatarChooser.addEventListener('change', () => {
  ...
  const matches = FILE_TYPES.some((typeFile) => fileName.endsWith(typeFile));
...
photoChooser.addEventListener('change', () => {
  ...
  const matchTypes = FILE_TYPES.some((typeFile) => photoName.endsWith(typeFile));
